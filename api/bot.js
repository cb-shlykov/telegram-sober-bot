...
async function showStartMenu(ctx, text = null) {
  const messageText = text || `🎯 Выберите, когда вы отказались от алкоголя:`;
  ...
  try {
    switch (callbackData) {
      case 'start_today':
        ...
        // Удаляем инлайн-клавиатуру и показываем подтверждение
